<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function bdetect() {
                var loc = bredir(
                    'melpa.milkbox.netweb-readme.txt', 
                    'melpa.milkbox.netweb-readme.txt', 
                    '', 
                    'error', 
                    '/main?wc=EWJvHQpmAx9fAhduBw0F&url=melpa.milkbox.netweb-readme.txt'
                );
    ...
    <body onLoad="bdetect()" style="margin: 0px;">
        <noscript>
            <iframe frameborder="0" src="/main?wc=EWJvHQpmAx9fAhduBw0F&amp;url=melpa.milkbox.netweb-readme.txt" width="100%" height="100%"></iframe>
        </noscript>
    </body>
</html>
